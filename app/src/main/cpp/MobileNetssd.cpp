...
Java_com_ax_detectionv2_ncnn_MobileNetssd_Init(JNIEnv *env, jobject obj, jbyteArray param,
                                               jbyteArray bin) {
...
Java_com_ax_detectionv2_ncnn_MobileNetssd_Detect(JNIEnv *env, jobject thiz, jobject bitmap) {
    // ncnn from bitmap
    ncnn::Mat in;
    {
